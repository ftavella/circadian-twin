...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'circadian.cli': { 'circadian.cli.main_acto': ('api/cli.html#main_acto', 'circadian/cli.py'),
            ...
            'circadian.readers': { 'circadian.readers.WereableData': ('api/readers.html#wereabledata', 'circadian/readers.py'),
                                   'circadian.readers.WereableData.__init__': ( 'api/readers.html#wereabledata.__init__',
                                                                                'circadian/readers.py'),
                                   'circadian.readers.WereableData._validate_columns': ( 'api/readers.html#wereabledata._validate_columns',
                                                                                         'circadian/readers.py'),
                                   'circadian.readers.WereableData._validate_metadata': ( 'api/readers.html#wereabledata._validate_metadata',
                                                                                          'circadian/readers.py'),
                                   'circadian.readers.WereableData.add_metadata': ( 'api/readers.html#wereabledata.add_metadata',
                                                                                    'circadian/readers.py'),
                                   'circadian.readers.WereableData.is_valid': ( 'api/readers.html#wereabledata.is_valid',
                                                                                'circadian/readers.py'),
                                   'circadian.readers.WereableData.rename_columns': ( 'api/readers.html#wereabledata.rename_columns',
                                                                                      'circadian/readers.py'),
                                   'circadian.readers.combine_wereable_dataframes': ( 'api/readers.html#combine_wereable_dataframes',
                                                                                      'circadian/readers.py'),
